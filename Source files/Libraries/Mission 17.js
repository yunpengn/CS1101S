...
function test_task2(player) {
	...
	var engine = new DeathCubeEngine(CONT_MODE, LAYOUT17B);
...
globals = [];export_symbol('DeathCubeEngine', DeathCubeEngine);
export_symbol('MakeAndInstallBot', MakeAndInstallBot);
...
export_symbol('STEP_MODE', STEP_MODE);
export_symbol('LAYOUT17A', LAYOUT17A);
})(window);
